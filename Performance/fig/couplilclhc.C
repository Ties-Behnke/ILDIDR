...
//=========  (Thu Nov 29 00:58:13 2012) by ROOT version5.34/02
   TCanvas *c1 = new TCanvas("c1", "histograms with bars",345,42,700,800);
   c1->Range(0,0,1,1);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
...
// ------------>Primitives in pad: c1_2
   ...
   TH2F *hFram = new TH2F("hFram","Couplings",5,0,5,100,0.0001,2);
   hFram->SetStats(0);
   ...
   hFram->GetXaxis()->SetTitleSize(0.035);
   ...
   hFram->GetYaxis()->SetLabelSize(0.035);
   hFram->GetYaxis()->SetTitleSize(0.035);
   hFram->GetYaxis()->SetTitleOffset(1.4);
   hFram->GetYaxis()->SetTitleFont(42);
   hFram->GetZaxis()->SetLabelFont(42);
   hFram->GetZaxis()->SetLabelSize(0.035);
   ...
   hDivFR__3__1__1->SetBarOffset(0.55);
   hDivFR__3__1__1->SetBarWidth(0.4);
   ...
   hDiv__2__2__2->SetBarOffset(0.1);
   hDiv__2__2__2->SetBarWidth(0.45);
   ...
   TLegend *leg = new TLegend(0.15,0.68,0.5,0.88,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
   ...
   TLegendEntry *entry=leg->AddEntry("NULL","ILC, #sqrt{s}=500 GeV, L=3200 fb^{-1}","f");
