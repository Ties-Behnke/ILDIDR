void IDR_JERs_uds_l5_vs_s5_Barrel()
{
//=========Macro generated from canvas: Canvas_1/Canvas_1
//=========  (Wed Dec 18 15:41:01 2019) by ROOT version6.08/06
   ...
   TH1F *Graph_Graph_Graph10011001 = new TH1F("Graph_Graph_Graph10011001","ILD",100,0,273);
   Graph_Graph_Graph10011001->SetMinimum(2.5);
   Graph_Graph_Graph10011001->SetMaximum(7);
   ...
   Graph_Graph_Graph10011001->SetMarkerSize(0.7);
   Graph_Graph_Graph10011001->GetXaxis()->SetTitle("E_{jet} [GeV]");
   Graph_Graph_Graph10011001->GetXaxis()->SetRange(1,99);
   ...
   Graph_Graph_Graph10011001->GetYaxis()->SetTitle("RMS_{90}(E_{j}) / Mean_{90}(E_{j}) [%]");
   ...
   Graph_Graph_Graph10011001->GetYaxis()->SetTitleOffset(1.1);
   ...
   TH1F *Graph_Graph_Graph10021002 = new TH1F("Graph_Graph_Graph10021002","IDR-S",100,0,273);
   Graph_Graph_Graph10021002->SetMinimum(2.858374);
   Graph_Graph_Graph10021002->SetMaximum(5.849195);
   ...
   Graph_Graph_Graph10021002->SetMarkerSize(0.7);
   Graph_Graph_Graph10021002->GetXaxis()->SetTitle("Jet energy [GeV]");
   ...
   Graph_Graph_Graph10021002->GetYaxis()->SetTitle("RMS_{90}(E_{j}) / Mean_{90}(E_{j}) [%]");
