void JERs_uds_l5_vs_s5_EndCap()
{
//=========Macro generated from canvas: JERs/Jet energy resolution
//=========  (Sun Dec  1 15:57:39 2019) by ROOT version6.08/06
   TCanvas *JERs = new TCanvas("JERs", "Jet energy resolution",0,0,650,650);
   gStyle->SetOptStat(0);
   JERs->Range(-65.71333,1.405405,292.7033,7.486486);
   ...
   Graph_Graph1001->SetMinimum(2.744459);
   Graph_Graph1001->SetMaximum(6.812771);
   ...
   Graph_Graph1002->SetMinimum(2.894572);
   Graph_Graph1002->SetMaximum(6.862212);
   ...
   Graph_Graph_Graph10011003->SetMinimum(2.744459);
   Graph_Graph_Graph10011003->SetMaximum(6.812771);
   ...
   Graph_Graph_Graph10021004->SetMinimum(2.894572);
   Graph_Graph_Graph10021004->SetMaximum(6.862212);
   ...
   Graph_Graph_Graph_Graph100110031005->SetMinimum(2.744459);
   Graph_Graph_Graph_Graph100110031005->SetMaximum(6.812771);
   ...
   Graph_Graph_Graph_Graph100210041006->SetMinimum(2.894572);
   Graph_Graph_Graph_Graph100210041006->SetMaximum(6.862212);
   ...
   TLegend *leg = new TLegend(0.5,0.4,0.9,0.7,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
   leg->SetLineColor(1);
   leg->SetLineStyle(1);
   ...
   TLegendEntry *entry=leg->AddEntry("NULL","|cos(#theta_{q#bar{q}})|>0.7","h");
   ...
   entry=leg->AddEntry("Graph","ILD-L","epl");
